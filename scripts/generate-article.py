...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18220726621"></script>
    <script>
...
<body>
    <nav>
        <div class="container">
            <a href="/" class="logo"><img src="../logo.png" alt="LC Patrimoine - Gestion de patrimoine en Île-de-France"></a>
    ...
    <header class="page-hero">
        <div class="container">
            <div class="breadcrumb"><a href="/">Accueil</a> <span>›</span> <a href="/blog">Blog</a> <span>›</span> {breadcrumb_short}</div>
            <h1>{title}</h1>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-about">
                    <a href="/" class="logo"><img src="../logo.png" alt="LC Patrimoine" style="height:36px;"></a>
